...
reportedWC_P2 = simps(Ir2[59:-1], t2021)
...
def reported(x):
    ...
    n1 = gauss(1, 0.05) # random number (mean, sd)
    n2 = gauss(1, 0.05) # random number (mean, sd)
    ...
    reportedP2 = simps(Ir21, t2021)
    patch2 = 1-(reportedP2/reportedWC_P2)
    return patch2
...
ax.hist(Y, bins=30, color='gold', edgecolor='k')
