...
reportedWC = simps(Ir1[34:-1]+Ir2[34:-1]+Ir3[34:-1], t2021)
...
def reported(x):
    ...
    reportedS1 = simps(Ir11+Ir21+Ir31, t2021)
    PERCENTAGE_REDUCTION_REPORTED = 1-(reportedS1/reportedWC)
...
'bounds': [[60, 90],[0.9, 0.95],[.4, .6],[0.01,0.1]] #ranges
}
