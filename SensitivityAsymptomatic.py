# -*- coding: utf-8 -*-
"""
Created on Wed Nov 11 14:24:18 2020
...
asymptomaticWC = simps(A1[34:-1]+A2[34:-1]+A3[34:-1], t2021)
#symptomaticWC = simps(I1[59:-1]+I2[59:-1]+I3[59:-1], t2021)
#reportedWC = simps(Ir1[59:-1]+Ir2[59:-1]+Ir3[59:-1], t2021)
...
def reported(x):
    ...
    thetaVector = np.array([theta, theta, theta])
    psiVector = np.array([psi, psi, psi])
    rhoV_Vector = np.array([rhoV, rhoV, rhoV])
    uVector = np.array([u, u, u])
    ...
    asymptomaticS1 = simps(A11+A21+A31, t2021)
    PERCENTAGE_REDUCTION = 1-(asymptomaticS1/asymptomaticWC)
...
problem = {
'num_vars': 4,  # number of parameters 
'names': ['Time', 'Efficacy','Coverage','Symptomatic'], 
'bounds': [[60, 150],[0.7, 0.95],[.2, .5],[0.01,0.5]] #ranges
}
...
ax.set_xlabel('Percentage reduction in the asymptomatic cases')
...
ax.bar(ind, FirstOrder, width, color='#d62728', label='First Order')
ax.bar(ind+width, TotalOrder, width, label='Total Order')
ax.set_xticks(ind+width/2)
ax.set_xticklabels((r'$T$', r'$\psi$', r'$C$', r'$\tilde{\rho}$'))
