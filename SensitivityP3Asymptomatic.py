...
asymptomaticWC_P3 = simps(A3[59:-1], t2021)
...
def reported(x):
    ...
    asymptomaticP3 = simps(A31, t2021)
    PERCENTAGE_REDUCTION_REPORTED = 1-(asymptomaticP3/asymptomaticWC_P3)
...
'bounds': [[1/365, 1/180],[30, 150],[0.5, 0.95],[.1, .5],[0.0,0.5]] #ranges
}
