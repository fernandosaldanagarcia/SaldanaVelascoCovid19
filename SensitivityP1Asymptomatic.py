...
asymptomaticWC_P1 = simps(A1[59:-1], t2021)
...
def reported(x):
    ...
    asymptomaticP1 = simps(A11, t2021)
    PERCENTAGE_REDUCTION_REPORTED = 1-(asymptomaticP1/asymptomaticWC_P1)
...
'bounds': [[1/365, 1/180],[30, 150],[0.5, 0.95],[.1, .5],[0.1,0.5]] #ranges
}
