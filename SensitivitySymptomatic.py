...
symptomaticWC = simps(I1[34:-1]+I2[34:-1]+I3[34:-1], t2021)
...
def reported(x):
    ...
    symptomaticS1 = simps(I11+I21+I31, t2021)
    PERCENTAGE_REDUCTION = 1-(symptomaticS1/symptomaticWC)
...
'bounds': [[30, 150],[0.5, 0.95],[.1, .8],[0.1,0.5]] #ranges
}
